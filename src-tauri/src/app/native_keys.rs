    ...
    use windows::{
        ...
        Win32::{
            ...
            Graphics::Gdi::{
                ...
                FillRect, GetStockObject, GetTextExtentPoint32W, InvalidateRect, LineTo, MoveToEx,
                RoundRect, SelectObject, SetBkMode, SetTextColor, TextOutW, UpdateWindow,
            ...
            UI::WindowsAndMessaging::{
                ...
                TranslateMessage, CS_HREDRAW, CS_VREDRAW, HWND_TOPMOST, LWA_COLORKEY, MSG,
                PM_REMOVE, SWP_NOACTIVATE, SWP_SHOWWINDOW, SW_HIDE, WM_DESTROY, WM_ERASEBKGND,
